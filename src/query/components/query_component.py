...
from src.query.components.query_builder import QueryBuilder
from src.query.types.request.query_options import QueryOptions
from src.query.types.result.result_query import QueryDataCollection, QueryDataElement


class QueryComponent(OmniComponent):
    def __init__(self, unity_cache: UnityCache, core: BaseCore,
                 factor_component: ComputationComponent):
    ...
    def search(self, query: QueryOptions) -> QueryDataCollection:
        ...
        data_collection = QueryDataCollection(self.core, q_data_set)
